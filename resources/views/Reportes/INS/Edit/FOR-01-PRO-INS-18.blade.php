            ...
            <form id="FOR-01-PRO-INS-18" action="{{route('Reportes_FOR_01_PRO_INS_18.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div style="margin-bottom: 2px;"></div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label class="col-form-label" for="inputSuccess">MARCA:</label>
                            <input type="text" class="form-control  inputForm" id="marcaInputE" name="Datos_Equipo[MARCA_CABLE]" placeholder="" value="{{ old('Datos_Equipo.MARCA_CABLE', $Datos_Equipo['MARCA_CALBE'] ?? '') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm" id="nsInputE" name="Datos_Equipo[FRECUENCIA]" placeholder="" value="{{ old('Datos_Equipo.FRECUENCIA', $Datos_Equipo['FRECUENCIA'] ?? '') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm" id="nsInputE" name="Datos_Equipo[GANANCIA_HZ]" placeholder="" value="{{ old('Datos_Equipo.GANANCIA_HZ', $Datos_Equipo['GANANCIA_HZ'] ?? '') }}"value="{{old('Datos_Equipo.GANANACIA_HZ')}}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm" id="nsInputE" name="Datos_Equipo[ESPESOR_PINTURA]" placeholder="" value="{{ old('Datos_Equipo.ESPESOR_PINTURA', $Datos_Equipo['ESPESOR_PINTURA'] ?? '') }}">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control  inputForm" id="nsInputE" name="Datos_Equipo[GANANCIA_VERTICAL]" placeholder=""value="{{ old('Datos_Equipo.GANANCIA_VERTICAL', $Datos_Equipo['GANANCIA_VERTICAL'] ?? '') }}">
                        </div>
                    </div>
